...
################################################################################
## Form generated from reading UI file 'userAccountTeacher.ui'
##
...
class Ui_UserAccountTeacher(object):
    def setupUi(self, UserAccountTeacher):
        if not UserAccountTeacher.objectName():
            UserAccountTeacher.setObjectName(u"UserAccountTeacher")
        UserAccountTeacher.resize(970, 558)
        self.verticalLayout_2 = QVBoxLayout(UserAccountTeacher)
        self.verticalLayout_2.setObjectName(u"verticalLayout_2")
        self.horizontalLayout = QHBoxLayout()
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.widget = QWidget(UserAccountTeacher)
...
"border-radius: 10px;")
        ...
        self.positionImg = QLabel(self.widget)
        self.positionImg.setObjectName(u"positionImg")
        self.positionImg.setMinimumSize(QSize(0, 80))
        self.positionImg.setMaximumSize(QSize(16777215, 80))
        self.positionImg.setAutoFillBackground(False)
        self.positionImg.setStyleSheet(u"image: url(:/icons/position.png);")
        self.positionImg.setScaledContents(False)

        self.gridLayout_11.addWidget(self.positionImg, 0, 2, 1, 1)
        ...
        self.departmentImg = QLabel(self.widget)
        self.departmentImg.setObjectName(u"departmentImg")
        self.departmentImg.setMinimumSize(QSize(0, 80))
        self.departmentImg.setMaximumSize(QSize(16777215, 80))
        self.departmentImg.setAutoFillBackground(False)
        self.departmentImg.setStyleSheet(u"image: url(:/icons/department.png);")
        self.departmentImg.setScaledContents(False)
        self.departmentImg.setAlignment(Qt.AlignCenter)

        self.gridLayout_11.addWidget(self.departmentImg, 0, 1, 1, 1)
        ...
        self.department.setMargin(5)
        self.department.setTextInteractionFlags(Qt.LinksAccessibleByMouse|Qt.TextSelectableByMouse)

        self.gridLayout_11.addWidget(self.department, 1, 1, 1, 1)
        ...
        self.position.setTextInteractionFlags(Qt.LinksAccessibleByMouse|Qt.TextSelectableByMouse)

        self.gridLayout_11.addWidget(self.position, 1, 2, 1, 1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 642, 180))
...
"text-align: left; padding-left: 10px;")
        ...
        self.retranslateUi(UserAccountTeacher)

        QMetaObject.connectSlotsByName(UserAccountTeacher)
    # setupUi

    def retranslateUi(self, UserAccountTeacher):
        UserAccountTeacher.setWindowTitle(QCoreApplication.translate("UserAccountTeacher", u"MainWindow", None))
        self.lastName.setText(QCoreApplication.translate("UserAccountTeacher", u"\u041f\u0440\u0456\u0437\u0432\u0438\u0449\u0435", None))
        self.firstName.setText(QCoreApplication.translate("UserAccountTeacher", u"\u0406\u043c'\u044f", None))
        self.patronymic.setText(QCoreApplication.translate("UserAccountTeacher", u"\u041f\u043e \u0431\u0430\u0442\u044c\u043a\u043e\u0432\u0456", None))
        self.positionImg.setText("")
        self.instituteImg.setText("")
        self.departmentImg.setText("")
        self.institute.setText(QCoreApplication.translate("UserAccountTeacher", u"\u0406\u043d\u0441\u0442\u0438\u0442\u0443\u0442", None))
        self.department.setText(QCoreApplication.translate("UserAccountTeacher", u"\u041a\u0430\u0444\u0435\u0434\u0440\u0430", None))
        self.position.setText(QCoreApplication.translate("UserAccountTeacher", u"\u041f\u043e\u0441\u0430\u0434\u0430", None))
        self.description.setText(QCoreApplication.translate("UserAccountTeacher", u"\"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.\"", None))
        self.email.setText(QCoreApplication.translate("UserAccountTeacher", u"teach@gmail.com", None))
        self.emailLabel.setText("")
        self.phone.setText(QCoreApplication.translate("UserAccountTeacher", u"+380971111111", None))
        self.phoneLabel.setText("")
        self.photoLabel.setText(QCoreApplication.translate("UserAccountTeacher", u"\u0424\u043e\u0442\u043e \u043f\u0440\u043e\u0444\u0456\u043b\u044e", None))
        self.choosePhoto.setText(QCoreApplication.translate("UserAccountTeacher", u"\u0417\u043c\u0456\u043d\u0438\u0442\u0438 \u0444\u043e\u0442\u043e", None))
        self.editAcc.setText(QCoreApplication.translate("UserAccountTeacher", u"\u0420\u0435\u0434\u0430\u0433\u0443\u0432\u0430\u0442\u0438 \u043f\u0440\u043e\u0444\u0456\u043b\u044c", None))
        self.logout.setText(QCoreApplication.translate("UserAccountTeacher", u"\u0412\u0438\u0439\u0442\u0438 \u0437 \u0430\u043a\u0430\u0443\u043d\u0442\u0443", None))
    # retranslateUi
